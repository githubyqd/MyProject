================================================================================
    MICROSOFT 基础类库 : SY 项目概述
===============================================================================

应用程序向导已为您创建了此 SY 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 SY 应用程序的每个文件的内容。
...
SYDoc.h、SYDoc.cpp - 文档
    这些文件包含 CSYDoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CSYDoc::Serialize）。

SYView.h、SYView.cpp - 文档视图
    这些文件包含 CSYView 类。
    CSYView 对象用于查看 CSYDoc 对象。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 SY.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
